<%-- 
    Ficheiro: admin_encomendas.jsp
    Descrição: Gestão de encomendas pelo administrador. Lista todas as encomendas
    com opção de ver, editar, cancelar e criar nova encomenda para qualquer cliente.
--%>
...
<div class="container">
    <div class="card">
        <h2>Gestão de Encomendas (Admin)</h2>
