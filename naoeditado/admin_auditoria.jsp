<%-- 
    Ficheiro: admin_auditoria.jsp
    Descrição: Registo de auditoria de todas as operações da carteira.
    Permite consultar, filtrar por tipo de operação, pesquisar por descrição
    e ordenar por data ou valor. Acessível apenas a administradores.
--%>
...
<div class="container">
    <div class="card">
        ...
        <!-- Filtros -->
        <form method="get" action="admin_auditoria.jsp" style="display:flex; flex-wrap:wrap; gap:10px; margin-bottom:15px; align-items:flex-end;">
            <div class="form-grupo" style="margin:0;">
                <label>Tipo de Operação:</label>
                <select name="tipo">
                    <option value="">Todos</option>
                    <option value="deposito" <%= "deposito".equals(request.getParameter("tipo")) ? "selected" : "" %>>Depósito</option>
            ...
            <a href="admin_auditoria.jsp" class="btn btn-cinza">Limpar</a>
        </form>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <% if ("deposito".equals(tipoOp)) { %><span style="color:#27ae60;">Depósito</span>
