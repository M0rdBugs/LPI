<%-- 
    Ficheiro: admin_perfil.jsp
    Descrição: Página de consulta e edição dos dados pessoais do administrador.
...
<div class="container">
    <div class="card">
        <h2>O Meu Perfil (Administrador)</h2>
        ...
        <%
            ...
            try {
                ...
                if (rs2.next()) {
        %>
        <form method="post" action="admin_perfil.jsp">
