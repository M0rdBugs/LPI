<%-- 
    Ficheiro: func_carteiras.jsp
    Descrição: Permite ao funcionário gerir o saldo das carteiras dos clientes.
    Pode consultar o saldo de qualquer cliente e adicionar/retirar saldo.
...
<div class="container">
    <div class="card">
        <h2>Gestão de Carteiras de Clientes</h2>
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                if ("levantar".equals(operacao) && valor > saldo) {
                                    ...
                                    stmt.setString(4, tipoOp);
                                    stmt.setString(5, "Operação pelo funcionário " + session.getAttribute("username") + " na carteira do cliente ID " + idCliente);
                                    stmt.executeUpdate(); stmt.close();
                                ...
                                mensagem = "Carteira não encontrada para este cliente.";
                                tipoMsg = "erro";
                            }
                        } catch (Exception e) {
        ...
        <!-- Listagem de clientes e saldos -->
        <h3>Saldos dos Clientes</h3>
        <%
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <form method="post" action="func_carteiras.jsp" style="display:inline;">
