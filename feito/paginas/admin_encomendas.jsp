<%--  
    Gestao de encomendas de qualquer cliente pelo administrador
    Lista todas as encomendas com JOIN's 
    Permite editar, cancelar e marcar como entregue
    Tabelas usadas: encomenda, produto, utilizador
--%>
...
<div class="container">
    <div class="card">
        <h2>Gestao de Encomendas (Administrador)</h2>
            ...
            <tr>
                ...
                <td>
                    <% if ("ativo".equals(estado)) { %>
                        ...
                        <a href="admin_encomendas.jsp?acao=entregar&id=<%= eid %>" class="btn btn-verde" style="font-size:0.8em;">Entregue</a>
                    <% } else { %>
                        -
                    <% } %>
                </td>
